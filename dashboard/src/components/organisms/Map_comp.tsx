...
type Props = {
    location: Location;
    markers: Array<Location>|null;
}

const Mapper: React.FC <Props> = ({location, markers}) => {
...
const Map_comp: React.FC <Props> = ({location, markers}) => {
    return (
        <MBox>
            <Title title='Map'/>
            <div className='h-[0.5rem]'></div>
            <Mapper location={location} markers={markers}/>
        </MBox>
    );
};
